...
if (maxWidth > 991) {
    ...
    function updateLang() {
        ...
        if (lang == 'ru') {
            ...
            setText('intro-about-description', `Я — молодой энтузиаст технологий с пылким интересом к новейшим инновациям. Мой путь в качестве инженера машинного обучения — захватывающее приключение изучения передовых инструментов и превращения их в реальные чудеса. Моя цель — оказывать положительное влияние, предлагая умные решения одно за другим. 🚀`);
            ...
            if (el.length) {
                about_date_ru = ['Сентябрь 2022 - Настоящее время', 'Сентябрь 2023 - Настоящее время', 'Сентябрь 2022 - Настоящее время']
